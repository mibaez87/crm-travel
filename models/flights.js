...
var flight = {
  ...
  getLaterFlights: function (departure, arrival, cb) {
    orm.getLaterFlights("trips", ["client_id", "dep_flight", "dep_airport", "dep_time", "arr_flight", "arr_airport", "arr_time"], "dep_date", "arr_date", departure, arrival, cb);
  },
